...
// The update freq/dips/ms only happens when the values change
static void lcd_draw_updateScreenAuto(void)
{
...
static void lcd_draw_updateFrequency(int frequency)
{
    current_frequency = frequency;
    lcd_draw_updateScreenAuto();
}

static void lcd_draw_updateDips(int dips)
{
    current_dips = dips;
    lcd_draw_updateScreenAuto();
}

static void lcd_draw_updateMs(float ms)
{
    current_max_ms = ms;
    lcd_draw_updateScreenAuto();
}
